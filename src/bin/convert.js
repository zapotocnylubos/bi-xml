...
const fs = require('fs'),
    xml2js = require('xml2js');     // npm install -g xml2js && npm link xml2js
...
areas.forEach(function (area) {
    const {
        ...
        energy, communications, military_adn_security,
    ...
    const output_filename = '../countries/' + area + '.xml';
